...
router.get("/tiendas/pedidosPendientes/:id_tienda", async (req,res)=>{
    const ordenes = await sequelize.query("SELECT t1.fecha, t3.nombre AS nombre_producto, t2.cantidad, t3.precio, t3.url_imagen, t4.nombre, t4.apellidos FROM orden t1" 
